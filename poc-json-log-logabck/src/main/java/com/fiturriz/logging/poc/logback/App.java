package com.fiturriz.logging.poc.logback;

import java.util.Date;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fiturriz.logging.poc.logback.model.Data;
import com.fiturriz.logging.poc.logback.model.Event;
import com.fiturriz.logging.poc.logback.model.LogData;
...
//        MDC.put(LOG_DATA,mapper.writeValueAsString(logData));
        MDC.put("logdata",mapper.writeValueAsString(logData));
